...
const SecurityAndGuidelines = () => {
    ...
    const sections = [
                ...
                <div className="space-y-4">
                    ...
                    <div className="pl-4 border-l-2 border-primary/20 space-y-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-subtext">Users retain the right to access, rectify, or request deletion of their data by contacting <a href="mailto:contact@ai-mall.in" className="text-primary hover:underline">contact@ai-mall.in</a>.</p>
                        </div>
                    </div>
                </div>
            )
        ...
        },
        {
            ...
            icon: <FileText className="w-5 h-5 text-primary" />,
            content: <p className="text-subtext">For questions, concerns, or rights-related requests, contact <a href="mailto:contact@ai-mall.in" className="text-primary hover:underline">contact@ai-mall.in</a>.</p>
        },
        {
            id: 12,
