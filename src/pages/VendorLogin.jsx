    ...
    const handleSubmit = (e) => {
        ...
        axios.post(apis.logIn, payload).then((res) => {
            ...
            if (res.data.role !== 'vendor') {
                setError(true)
                setMessage("Access Denied: This portal is for Vendors only.")
                setLoading(false)
                return;
            }
            ...
            const from = location.state?.from?.pathname || AppRoute.VENDOR;
        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 bg-surface">
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className=" text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-maintext mb-2">Vendor Portal</h2>
                    <p className="text-subtext">Sign in to manage your apps and revenue</p>
                </div>
