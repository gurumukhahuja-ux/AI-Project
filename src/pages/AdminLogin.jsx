...
const AdminLogin = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(apis.logIn, payload).then((res) => {
            ...
            const from = location.state?.from?.pathname || AppRoute.ADMIN;
        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 bg-surface">
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className=" text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-maintext mb-2">Admin Portal</h2>
                    <p className="text-subtext">Authorized Personnel Only</p>
                </div>
