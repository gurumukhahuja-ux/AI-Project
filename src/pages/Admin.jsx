      ...
      `}>
        ...
        <div className="p-4 border-t border-[#E0E4E8]">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 text-subtext hover:text-primary hover:bg-primary/5 rounded-xl transition-colors text-sm font-bold"
          >
