          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <button
                ...
                className={`w-12 h-6 rounded-full p-1 transition-colors duration-300 flex items-center ${auto.active ? 'bg-green-500 justify-end' : 'bg-secondary/50 justify-start'
                  }`}
              >
